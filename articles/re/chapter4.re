...
@<b>{マジでモテます。}街を歩くとすれ違う人の3割が振り向き、その半数は握手となんなら抱擁を求めてきます。おまけにガリガリ君を食べると必ず当たりが出ますしお茶を飲むの必ず茶柱が立ちます。すいませんウソです。

でも（ここからはマジでマジな話）Kubernetesをはじめとするクラウドネイティブ技術を使いこなせるエンジニアは本当に不足しています。Kubernetesのエンジニアは飛びぬけて転職に有利、といったアメリカでの調査もありましたが@<fn>{kubernetes-recruiting}、実際日本でも、LinkedInのプロファイルにCertified Kubernetes Administrator(CKA)とか書いてあると、毎日のようにスカウトメールがバンバン来ます。なんなら私が出します。

Kuberntesは近いうちに幻滅期を迎えるとか、技術の栄枯盛衰は早いので追いかけてもしょうがない、みたいな斜に構えた意見も目にします。ですが、例えばKubernetesを使いこなせるということは、少なくともInfrastructure as Codeを理解して記述できるということの証明となります。これはインフラエンジニアにとっても、アプリケーションエンジニアにとっても、この先生@<b>{きのこる}ためには欠かせない素養であり、たとえKubernetesがなくなったとしても強力なスキルセットとなります。で、実際それができる人はまだ（残念ながら）本当に少ない。

それ以前に、楽しいですよ。楽しく仕事してる人はモテます。本当に。

//footnote[kubernetes-recruiting][https://www.publickey1.jp/blog/19/kuberenetesdiceindeed.html]
