...
スケーラブルで堅牢なアーキテクチャをマイクロサービスで実現し、Cloud Nativeアプリ開発らしさを出すという目的は、今回のshowKsで概ね達成できました。しかし、カンファレンスという特殊な環境において、わかりやすい展示になることを優先させた部分は少なからずありました。そのため、アプリケーションの構成が実際の企業のシナリオとは少し異なったものとなってしまったかもしれません。
