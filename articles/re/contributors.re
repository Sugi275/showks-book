...
==== @tsukaman
日本ヒューレット・パッカード株式会社 Pointnext Hybrid IT Practice/COE 所属。
コミュニティとしてはコンテナ系としてRancher JP、Mesos User Group Tokyoあたりに運営メンバーとして参加。
showKsでは賑やかし役とランディングページおよび参加手順ページ、ブース配布物およびポスターの作成などを担当。
当書籍でも賑やかし精神を発揮し、謎のコラムを書いたりしています。あと、眼鏡が好き。とても好き。
RasPiも好きなので、Rancher方面で騒がしいk3sのことを頑張りたいなーと思っている今日この頃です。
