...
//indepimage[01/pre1][フォーム][scale=0.5]

あなた専用のキャンバスが出来ていて

//indepimage[01/pre2][フォーム][scale=0.5]

GitHubリポジトリやCIパイプラインやCDパイプラインが出来ている。

//indepimage[01/pre3][フォーム][scale=0.5]
//indepimage[01/pre4][フォーム][scale=0.5]
//indepimage[01/pre5][フォーム][scale=0.5]

そしてポータルでみんなの絵が見られる。

//indepimage[01/pre6][フォーム][scale=0.5]
