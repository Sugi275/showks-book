...
Kubernetesやクラウドネイティブ界隈はまだ技術的進化がとても早くなっています。
Kubernetes自体も3ヶ月に一度メジャーアップデートを行なっていますし、Cloud Native Landscapeに書かれているプロジェクトやプロダクトもどんどん増加していっています。@<fn>{cncf-landscape}
なお、執筆時点（2019-04-01）で662個のプロジェクトやプロダクトが登録されており、とても1つの企業だけで把握しきるのは困難です。
そんな時はMeetupなどのコミュニティに参加し、積極的に情報交換すると良いでしょう（仲間にいれたそうにそちらをみている）。
...
他にも、Spinnakerを別のCDツールに置き換えるなども手段の一つでしょう。さらにモテモテだ。
